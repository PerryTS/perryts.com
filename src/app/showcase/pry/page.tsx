...
export default function PryShowcase() {
  const features = [
    {
      title: "Tree View",
      description:
    ...
    },
    {
      ...
      description: "Copy any node or subtree to clipboard as formatted JSON.",
    },
    {
      title: "Status Bar",
      description:
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mb-8">
            A fast, native JSON viewer built with Perry. Tree navigation, search,
            keyboard shortcuts — compiled from TypeScript to native binaries.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-slate-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">How It&apos;s Built</h2>
          <p className="text-lg text-slate-400 mb-8 max-w-2xl">
            Pry is written in TypeScript and compiled with Perry to a native binary.
            No Electron, no web views, no JavaScript runtime.
          </p>

          <div className="grid sm:grid-cols-3 gap-4 mb-12">
            <div className="feature-card text-center">
              <div className="text-3xl mb-2">📝</div>
              <h3 className="font-semibold text-white mb-1">TypeScript Source</h3>
            ...
            <div className="feature-card text-center">
              <div className="text-3xl mb-2">⚡</div>
              <h3 className="font-semibold text-white mb-1">Perry Compile</h3>
              <p className="text-sm text-slate-400">
            ...
            <div className="feature-card text-center">
              ...
              <h3 className="font-semibold text-white mb-1">Native Binary</h3>
              <p className="text-sm text-slate-400">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="feature-card overflow-hidden p-0">
              <div className="aspect-video bg-slate-800/50 flex items-center justify-center text-slate-500">
                <p className="text-sm">macOS screenshot — coming soon</p>
              </div>
            </div>
            <div className="feature-card overflow-hidden p-0">
              <div className="aspect-video bg-slate-800/50 flex items-center justify-center text-slate-500">
                <p className="text-sm">iOS screenshot — coming soon</p>
              </div>
            </div>
          </div>
          <p className="text-sm text-slate-500 mt-4">
            Screenshots will be added as Pry development continues. Check the{" "}
            <a
              href="https://github.com/nicktrebes/perry-pry"
              target="_blank"
              rel="noopener noreferrer"
              className="text-perry-400 hover:text-perry-300"
            >
              GitHub repo
            </a>{" "}
            for the latest.
