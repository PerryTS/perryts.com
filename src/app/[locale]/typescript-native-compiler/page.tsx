...
export const metadata: Metadata = {
  title: "TypeScript Native Compiler: How Perry Compiles TS to Machine Code",
  description:
  ...
  alternates: {
    canonical: "/en/typescript-native-compiler/",
  },
  openGraph: {
    title: "TypeScript Native Compiler: How Perry Compiles TS to Machine Code",
    description:
      "SWC parsing, a typed HIR with monomorphization, LLVM codegen. Native binaries for 10 platforms, no VM.",
    url: "/en/typescript-native-compiler/",
    type: "article",
  },
};
