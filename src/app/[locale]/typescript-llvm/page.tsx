...
export const metadata: Metadata = {
  title: "TypeScript on LLVM: Monomorphization and Native Codegen",
  description:
  ...
  alternates: {
    canonical: "/en/typescript-llvm/",
  },
  openGraph: {
    title: "TypeScript on LLVM: Monomorphization and Native Codegen",
    description:
      "A typed HIR, monomorphization, NaN-boxing — and why Perry moved from Cranelift to LLVM.",
    url: "/en/typescript-llvm/",
    type: "article",
  },
};
    ...
    <main className="min-h-screen">
      <JsonLd
        data={breadcrumbJsonLd([
          ...
          { name: "TypeScript on LLVM", path: `/${locale}/typescript-llvm/` },
        ])}
      />
      <Header />
