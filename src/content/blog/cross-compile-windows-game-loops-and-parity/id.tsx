...
export default function Content() {
  return (
    <>
      <p>
        103 commit ke compiler Perry minggu ini. Fitur utama: Anda sekarang bisa cross-compile
        executable Windows dari Linux, aplikasi iOS bisa menjalankan game loop blocking, compiler melaporkan
        crash untuk telemetri, dan compiler self-hosting lolos setiap tes deterministik yang kami berikan.
        Ditambah upgrade infrastruktur Hub besar dan 50+ perbaikan bug.
      </p>

      <h2>Cross-Compile ke Windows dari Linux</h2>
      <p>
      ...
      <h2>Hub: Pipeline Build Windows Dua Tahap</h2>
      <p>
      ...
      <h2>API Menu Lintas Platform</h2>
      <p>
      ...
      <h2>Anvil: 100% Paritas Tes Deterministik</h2>
      <p>
