...
export default function Content() {
  return (
    <>
      <p>
        本周 Perry 编译器 103 次提交。主要特性：现在可以从 Linux 交叉编译
        Windows 可执行文件，iOS 应用可以运行阻塞式游戏循环，编译器报告
        崩溃用于遥测，自托管编译器通过了所有确定性测试。
        加上重大 Hub 基础设施升级和 50+ 个错误修复。
      </p>

      <h2>从 Linux 交叉编译到 Windows</h2>
      <p>
