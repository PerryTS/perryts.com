...
perry run tvos`}</code></pre>
      ...
      <h2>Cross-Compile iOS dan macOS dari Linux</h2>
      <p>
      ...
      <h2>Notarisasi macOS dan Code Signing</h2>
      <p>
      ...
      <h2>Paket Baru: perry/appstorereview</h2>
      <p>
