...
export default function Content() {
  return (
    <>
      <p>
        82 commit trong bảy ngày. Trang tài liệu với 49 trang. Xuất bản App Store và Play Store tự động.
        Gói Homebrew và APT. Extension WidgetKit native biên dịch từ TypeScript.
        Trình biên dịch LLVM tự host. Và hàng chục bản sửa lỗi trên mọi nền tảng.
      </p>
      <p>
      ...
      <h2>Cài đặt Perry bằng một lệnh</h2>
      <p>
      ...
      <h2>Xuất bản App Store tự động</h2>
      <p>
      ...
      <h2>Widget mới và cải tiến nền tảng</h2>
      <p>
      ...
      <h2>Sửa lỗi GC và tính đúng đắn</h2>
      <p>
