...
export default function Content() {
  return (
    <>
      <p>
        Seminggu yang lalu, Perry adalah compiler dengan UI toolkit. Anda bisa menulis TypeScript, mengkompilasinya
        menjadi binary native, dan mendistribusikannya di enam platform. Itu ceritanya. Hari ini ceritanya lebih besar: Perry menjadi sebuah ekosistem. Tiga database ORM, push notification universal,
        distributed build dengan publikasi App Store dan Play Store, layer kompatibilitas React,
        dan verifikasi aplikasi otomatis — semuanya hadir dalam seminggu terakhir.
      </p>
      <p>
        This post covers what shipped, why it matters, and what the code looks like.
      </p>

      <h2>perry/ui: Fondasi</h2>
      <p>
      ...
      <h2>Kompatibilitas React: Layer Tipis di atas perry/ui</h2>
      <p>
      ...
      <h2>Tiga Database ORM: API Prisma, Performa Native</h2>
      <p>
      ...
      <h2>perry-push: Push Notification Universal</h2>
      <p>
      ...
      <h2>Perry Hub + Builder: Build Cloud Terdistribusi</h2>
      <p>
      ...
      <h2>perry-verify: Verifikasi Aplikasi Otomatis</h2>
      <p>
