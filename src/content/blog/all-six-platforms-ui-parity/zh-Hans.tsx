...
export default function Content() {
  return (
    <>
      <p>
        当我们发布 Perry 原生 UI 系统的第一个版本时，&quot;跨平台&quot;
        意味着 macOS 运行良好，而其他五个平台还只是存根。如今，在 v0.2.162 版本中，情况
        不再如此。所有六个平台 —— macOS、iOS、iPadOS、Android、Linux 和 Windows —— 现在
        共享完整的功能对等。相同的 TypeScript 代码在每个目标上编译为原生组件。
      </p>
      <p>
      ...
      <h2>Canvas：从 TypeScript 进行 2D 绘图</h2>
      <p>
      ...
      <h2>Table 组件：NSTableView 来到 TypeScript</h2>
      <p>
