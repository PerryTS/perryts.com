          ...
          <div className="hidden md:flex items-center gap-5 lg:gap-8">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M20.317 4.369A19.791 19.791 0 0015.415 2.85a13.772 13.772 0 00-.626 1.292 18.27 18.27 0 00-5.575 0A13.629 13.629 0 008.588 2.85a19.736 19.736 0 00-4.904 1.52C.582 8.96-.29 13.438.13 17.853a19.9 19.9 0 006.01 3.028 14.554 14.554 0 001.287-2.083 12.934 12.934 0 01-2.03-.973c.17-.124.337-.253.5-.386a14.236 14.236 0 0012.21 0c.164.133.33.262.5.386-.648.38-1.329.707-2.032.974.37.73.8 1.427 1.287 2.082a19.864 19.864 0 006.013-3.028c.5-5.119-.852-9.556-3.558-13.484zM8.02 15.14c-1.172 0-2.134-1.076-2.134-2.399 0-1.324.943-2.4 2.134-2.4 1.192 0 2.154 1.085 2.134 2.4 0 1.323-.942 2.399-2.134 2.399zm7.974 0c-1.172 0-2.134-1.076-2.134-2.399 0-1.324.943-2.4 2.134-2.4 1.192 0 2.154 1.085 2.134 2.4 0 1.323-.942 2.399-2.134 2.399z" />
              </svg>
              {t("discord")}
            </a>
            <a
