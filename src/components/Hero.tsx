    ...
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl sm:text-2xl text-slate-400 max-w-3xl mx-auto mb-12">
          {t.rich("subheadline", {
            platforms: (chunks) => <span className="text-slate-300">{chunks}</span>,
          })}
        </p>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="code-block glow">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-500">{t("compiling")}</p>
              <p className="text-green-400">{t("compiled")}</p>
              <p className="mt-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold gradient-text">{t("appStore")}</div>
            <div className="text-slate-500 text-sm mt-1">{t("readyLabel")}</div>
          </div>
        </div>
      </div>
    </section>
