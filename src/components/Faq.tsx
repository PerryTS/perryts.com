...
const faqs: FaqEntry[] = [
  {
    question: "Does Perry need Node.js?",
    answer:
  ...
  {
    question: "How big are the binaries?",
    answer:
  ...
  {
    question: "What platforms does Perry support?",
    answer:
  ...
  {
    question: "Is Perry free?",
    answer:
      "The compiler is free and open source. Compiling and running locally costs nothing and requires no account. Perry Publish — the hosted build, signing, and store-submission pipeline — has a free tier (15 publishes per month) and a Pro plan.",
  },
  {
    question: "How is Perry different from bun build --compile or deno compile?",
    answer:
      "Bun and Deno bundle your JavaScript together with their runtime into one file — a hello world is roughly 60–100 MB depending on platform, and the code is still JIT-executed. Perry compiles TypeScript ahead of time to machine code via LLVM: no embedded engine, ~330 KB hello world, ~1 ms startup.",
  },
  {
    question: "Can Perry build GUI apps?",
    answer:
      "Yes. perry/ui is a declarative, SwiftUI-style API with 25+ widgets that maps to real platform controls on all six native UI platforms — no webview, no HTML rendering.",
  },
  {
    question: "Is Perry production-ready?",
    answer:
